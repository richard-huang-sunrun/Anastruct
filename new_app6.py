...
def calculate_capacity(spans, spacing, depth, breadth, pitch, overhang, E, Emin, Fb, Fv, G, CF_B, Cr, CD_D, CD_L, CD_S, CD_W, vaulted):
...
def process_roofs():
    ...
    for roof_data in data['roofs']:
        ...
        vaulted = roof_data.get('vaulted', False)
        ...
        capacity = calculate_capacity(spanscap, member_spacing,  framing_depth,framing_breadth, deg_pitch, overhang,
                                      ...
                                      specific_gravity_G,CF_B, Cr, CD_D, CD_L, CD_S, CD_W, vaulted)
