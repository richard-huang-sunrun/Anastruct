...
def calculate_capacity(spans, spacing, depth, breadth, pitch, overhang,E,Emin,Fb,Fv,G):
...
def process_roofs():
    ...
    for roof_data in data['roofs']:
        ...
        snow_string = [snow_pre_pv, snow_post_pv]
        ...
        for load_combination, load_cases in load_combinations:
            ...
            negative_shear_array = [positive_shear_array[i] - rxn_array[i] for i in range(len(positive_shear_array))]

            total_shear = positive_shear_array + rxn_array
        ...
        capacity = calculate_capacity(spans, member_spacing, framing_breadth, framing_depth, deg_pitch, overhang,
